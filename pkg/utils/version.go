...
var (
	...
	// KubeV1180Alpha1 indicates the version of Kubernetes v1.18.0-alpha.1
	KubeV1180Alpha1 = version.MustParseSemantic("v1.18.0-alpha.1")
)
...
// ClusterLifecycleEnabled is used to indicate whether clusterLifecycle Controller can be started
func ClusterLifecycleEnabled(kubeServerVersion string) (bool, error) {
	parsedVersion, err := version.ParseSemantic(kubeServerVersion)
	if err != nil {
		return false, err
	}

	return parsedVersion.AtLeast(KubeV1180Alpha1), nil
}